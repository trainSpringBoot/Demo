...
<body class="">
	<div class="wrapper ">
		<div class="sidebar" data-color="purple" data-background-color="white"
			data-image="/view/assets//img/sidebar-1.jpg">
			<div class="logo">
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">Loại sản phẩm</a>
					</div>
										...
										<div class="nav-tabs-wrapper">
											<ul class="nav nav-tabs" data-tabs="tabs">
												<li class="nav-item"><a class="nav-link active"
													href="#profile" data-toggle="tab"> Form
														<div class="ripple-container"></div>
												</a></li>
												<li class="nav-item"><a class="nav-link"
													href="#messages" data-toggle="tab"> Danh sách sản phẩm
														<div class="ripple-container"></div>
												</a></li>
								...
								<div class="card-body">
									<div class="tab-content">
										<div class="tab-pane active" id="profile">
											<form:form action="/category" modelAttribute="item">
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<label class="bmd-label-floating">Mã loại sản phẩm</label>
															<form:input path="idcategory" type="text"
																class="form-control" />
														</div>
													</div>
													<div class="col-md-12">
														<div class="form-group">
															...
															<form:input path="namecategory" type="text"
																class="form-control"/>
														</div>
													</div>
												</div>
												<button type="submit" formaction="/category" class="btn btn-primary pull-right">Mới</button>
												<button type="submit" formaction="/category/create" class="btn btn-primary pull-right">Thêm</button>
												<button type="submit" formaction="/category/delete/${item.idcategory}" class="btn btn-primary pull-right">Xoá</button>
												<button type="submit" formaction="/category/update" class="btn btn-primary pull-right">Cập
													nhật</button>
												...
												<tbody>
													<c:forEach var="item" items="${category}">
														<tr>
															...
															<td><a href="/category/edit/${item.idcategory}">Chỉnh</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
		...
		<div class="dropdown show-dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li class="active"><a class="img-holder switch-trigger"
					href="javascript:void(0)"> <img src=./view/assets//img/sidebar-1.jpg
						" alt="">
				</a></li>
				<li><a class="img-holder switch-trigger"
					href="javascript:void(0)"> <img src="/view/assets//img/sidebar-2.jpg"
						alt="">
				</a></li>
				<li><a class="img-holder switch-trigger"
					href="javascript:void(0)"> <img src="/view/assets//img/sidebar-3.jpg"
						alt="">
				</a></li>
				<li><a class="img-holder switch-trigger"
					href="javascript:void(0)"> <img src="/view/assets//img/sidebar-4.jpg"
						alt="">
				</a></li>
	...
	<script src="/view/assets//js/material-dashboard.js?v=2.1.2"
