									...
									<div class="tab-content">
										<div class="tab-pane active" id="profile">
											<form:form action="/product" modelAttribute="item">
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<form:input path="idproduct" type="text"
																class="form-control" />
														</div>
													</div>
													<div class="col-md-12">
														<div class="form-group">
															...
															<form:input path="nameproduct" type="text"
																class="form-control"/>
														</div>
													</div>
													<div class="col-md-12">
												...
												<button type="submit" formaction="/product" class="btn btn-primary pull-right">Mới</button>
												<button type="submit" formaction="/product/create" class="btn btn-primary pull-right">Thêm</button>
												<button type="submit" formaction="/product/delete/${item.idproduct}" class="btn btn-primary pull-right">Xoá</button>
												<button type="submit" formaction="/product/update" class="btn btn-primary pull-right">Cập
													nhật</button>
												...
												<tbody>
													<c:forEach var="item" items="${pro}">
														<tr>
															...
															<td><a href="/product/edit/${item.idproduct}">Chỉnh</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
