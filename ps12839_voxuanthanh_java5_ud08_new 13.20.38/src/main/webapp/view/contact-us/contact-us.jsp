			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown"
						...
						<li class="nav-item"><a class="nav-link" href="/about/view">About
								Us</a></li>
						<li class="dropdown megamenu-fw"><a href="#"
							class="nav-link dropdown-toggle " data-toggle="dropdown">Product
						...
						<li class="dropdown"><a href="#"
							class="nav-link dropdown-toggle " data-toggle="dropdown">Shop
						...
						<li class="nav-item"><a class="nav-link" href="/service/view">Our
								Service</a></li>
						<li class="nav-item"><a class="nav-link" href="/contact/view">Contact
								Us</a></li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
			...
			<div class="row">
				...
				<div class="col-lg-8 col-sm-12">
					<div class="contact-form-right">
						...
						<form:form action="/mailer/send" method="post"
							enctype="multipart/form-data" modelAttribute="mailinfo">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<div>From:</div>
										<form:input cssClass="form-control" path="from" value="thanhvx08062001@gmail.com" cssErrorClass="Xin hãy nhập Email của bạn"/>
								...
								<div class="col-md-12">
									<div class="form-group">
										<div>To:</div>
										<form:input cssClass="form-control" path="to" value="thanhvx08062001@gmail.com" cssErrorClass="Xin hãy nhập Email của bạn"/>
										<div class="help-block with-errors"></div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<div>Subject:</div>
										<form:input cssClass="form-control" path="subject" cssErrorClass="Chủ đề không được để trống" />
										<div class="help-block with-errors"></div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<div>Body:</div>
										<form:textarea cssClass="form-control" path="body" rows="3" cols="30" cssErrorClass="Viết tin nhắn của bạn" />
										<div class="help-block with-errors"></div>
									</div>
								</div>
								<hr />
								<div class="submit-button text-center">
									<input class="btn hvr-hover" type="submit" value="Send" />
