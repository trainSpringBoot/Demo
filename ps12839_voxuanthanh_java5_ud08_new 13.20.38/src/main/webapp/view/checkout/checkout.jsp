    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/home/index"><img src="/images/logo.png" class="logo" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/about/view">About Us</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="/checkout/view">Checkout</a></li>
                            <li><a href="/myaccount/view">My Account</a></li>
                            <li><a href="/wishlist/view">Wishlist</a></li>
                            <li><a href="/shop-detail/view">Shop Detail</a></li>
                        </ul>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="/service/view">Our Service</a></li>
                    <li class="nav-item"><a class="nav-link" href="/contact/view">Contact Us</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            ...
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><a data-toggle="collapse" href="#formLogin" role="button" aria-expanded="false">Click here to
                            Login</a></h5>
                    <form class="mt-3 collapse review-form-box" id="formLogin" action="/account/login" method="post">
                        <div class="form-row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><a data-toggle="collapse" href="#formRegister" role="button" aria-expanded="false">Click here to
                            Register</a></h5>
                    <form:form class="mt-3 collapse review-form-box" id="formRegister" action="/saveorUpdate" modelAttribute="Account" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="InputName" class="mb-0">Username</label>
                                <form:input type="text" class="form-control" path="username"  placeholder="First Name" /> 
                                <form:errors path="username" cssClass="error"></form:errors>
                                </div>
                            <div class="form-group col-md-6">
                                <label for="InputLastname" class="mb-0">Email</label>
                                <form:input type="email" class="form-control" path="email"  placeholder="Enter Email" />
                                <form:errors path="email" cssClass="error"></form:errors>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="InputEmail1" class="mb-0">Fullname</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="InputPassword1" class="mb-0">Photo</label>
                                <input type="file" class="form-control" name="image" placeholder="photo" accept=" image/ipg, image/ipeg"/>
                        ...
                        <button type="reset" class="btn hvr-hover">Cancel</button>
                    </form:form>
                </div>
            </div>
            <div class="row">
