...
<link rel="stylesheet" href="/css/cartdrop.css">
<!-- Responsive CSS -->
					...
					<ul>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-expanded="false"> <i
								class="fa fa-shopping-bag"></i><span class="badge">${sumcart}</span> 
								...
								<c:forEach var="item" items="${cart.items}">
									<li><span class="item"> <span class="item-left">
												...
												style="width: 40px; height: 65px;" /> <span
												class="item-info"> <span>${item.name}</span> <span>${item.price * item.qty}</span>
													<td class="quantity-box"><input name="qty"
														value="${item.qty}" onblur="this.form.submit()"
														style="width: 50px;"></td>
											</span>
										</span> <span class="item-right"> <a
												href="/cart/remove/${item.id}" class="btn btn-danger btn-xs"><span
													class="glyphicon glyphicon-remove"></span> Del</a>
										</span>
									</span></li>

									<li class="divider"></li>
									<li><a class="text-center" href="/cart/view">View Cart</a></li>
								</c:forEach>
							</ul>
							</li>
		...
		<div class="container">
							...
							<tbody>
								<c:forEach var="item" items="${cart.items}">
									<form action="/cart/update/${item.id}" method="post">
										...
										<tr>
											<td>${item.id}</td>
											<td><img src="${item.image}" alt="" width="220"
												height="220"></td>
											<td>${item.name}</td>
											<td>${item.price}</td>
											<td class="quantity-box"><input name="qty"
			...
			<div class="row my-5">
				...
				<div class="col-12 d-flex shopping-box">
					<a href="/cart/checkout" class="ml-auto btn hvr-hover">Checkout</a>
				</div>
			</div>
