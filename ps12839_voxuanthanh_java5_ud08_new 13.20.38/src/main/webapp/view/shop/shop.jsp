                    ...
                    <div class="product-categori">
                        <div class="search-product">
                            <form action="/shop/shop" method="post">
                                <input class="form-control" name="keywords" value="${keywords}" placeholder="Search here..." type="text">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="${item.image}" class="img-fluid" alt="Image" style="width: 264.98px;height:343.48px;">
                                                    <div class="mask-icon">
                                                        <ul>
